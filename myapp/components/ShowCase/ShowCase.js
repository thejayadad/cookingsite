    ...
    <section className='bg-light min-h-[640px] mx-auto px-3 flex items-center py-16'>
      <div className='container max-w-[1200px] mx-auto grid md:grid-cols-2 gap-14'>
        <div className='flex flex-col justify-center items-start'>
          ...
          <Link
            href={'/'}
            className='bg-lighter font-barlow px-4 min-w-[158px] min-h-[48px] inline-flex items-center justify-center uppercase text-white transition duration-300 ease-in-out hover:bg-lion-dark mt-8 tracking-widest'
          >
            See More
          </Link>
        </div>
